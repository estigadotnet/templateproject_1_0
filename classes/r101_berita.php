...
/**
 * Table class for r101_berita
 */
class r101_berita extends ReportTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'r101_berita';
		$this->TableName = 'r101_berita';
		$this->TableType = 'REPORT';

		// Update Table
		$this->UpdateTable = "`t101_berita`";
		$this->ReportSourceTable = 't101_berita'; // Report source table
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new ReportField('r101_berita', 'r101_berita', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->IsAutoIncrement = TRUE; // Autoincrement field
		$this->id->IsPrimaryKey = TRUE; // Primary key field
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->id->SourceTableVar = 't101_berita';
		$this->fields['id'] = &$this->id;

		// Tanggal
		$this->Tanggal = new ReportField('r101_berita', 'r101_berita', 'x_Tanggal', 'Tanggal', '`Tanggal`', CastDateFieldForLike("`Tanggal`", 7, "DB"), 135, 19, 7, FALSE, '`Tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->Tanggal->SourceTableVar = 't101_berita';
		$this->fields['Tanggal'] = &$this->Tanggal;

		// Berita
		$this->Berita = new ReportField('r101_berita', 'r101_berita', 'x_Berita', 'Berita', '`Berita`', '`Berita`', 201, 65535, -1, FALSE, '`Berita`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Berita->Nullable = FALSE; // NOT NULL field
		$this->Berita->Required = TRUE; // Required field
		$this->Berita->Sortable = TRUE; // Allow sort
		$this->Berita->SourceTableVar = 't101_berita';
