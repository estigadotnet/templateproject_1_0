...
// Create page object
$d101_berita_dashboard = new d101_berita_dashboard();

// Run the page
$d101_berita_dashboard->run();
...
$d101_berita_dashboard->Page_Render();
?>
...
<?php $d101_berita_dashboard->showPageHeader(); ?>
<?php
$d101_berita_dashboard->showMessage();
?>
<!-- Dashboard Container -->
...
<!-- /.ew-report -->
<?php
$d101_berita_dashboard->showPageFooter();
if (Config("DEBUG"))
...
<?php
$d101_berita_dashboard->terminate();
?>