 ...
 * Page class
 */
class t101_berita_view extends t101_berita
{
	...
	// Page object name
	public $PageObjName = "t101_berita_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t101_beritalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t101_beritalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t101_beritalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
