 ...
 * Page class
 */
class d101_berita_dashboard extends ReportTable
{
	...
	// Table name
	public $TableName = 'd101_berita';

	// Page object name
	public $PageObjName = "d101_berita_dashboard";
	...
	public function __construct()
	{
		...
		// Initialize
		$this->TableVar = 'd101_berita';
		$this->TableName = 'd101_berita';
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'd101_berita');
	...
	public function run()
	{
		...
		if (!$this->setupApiRequest()) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 'd101_berita');
			if ($Security->isLoggedIn())
