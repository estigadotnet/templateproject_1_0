...
class t002_tahunajaran extends DbTable
{
	...
	public function __construct()
	{
		...
		// TahunAjaran
		$this->TahunAjaran = new DbField('t002_tahunajaran', 't002_tahunajaran', 'x_TahunAjaran', 'TahunAjaran', 'concat(Mulai, \'/\', Selesai)', 'concat(Mulai, \'/\', Selesai)', 200, 9, -1, FALSE, 'concat(Mulai, \'/\', Selesai)', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->TahunAjaran->IsCustom = TRUE; // Custom field
	...
	{
		return ($this->SqlSelect != "") ? $this->SqlSelect : "SELECT *, concat(Mulai, '/', Selesai) AS `TahunAjaran` FROM " . $this->getSqlFrom();
	}
