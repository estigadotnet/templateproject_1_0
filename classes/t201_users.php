...
class t201_users extends DbTable
{
	...
	public function __construct()
	{
		...
		// UserLevel
		$this->UserLevel = new DbField('t201_users', 't201_users', 'x_UserLevel', 'UserLevel', '`UserLevel`', '`UserLevel`', 3, 11, -1, FALSE, '`UserLevel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sekolah_id
		$this->sekolah_id = new DbField('t201_users', 't201_users', 'x_sekolah_id', 'sekolah_id', '`sekolah_id`', '`sekolah_id`', 3, 11, -1, FALSE, '`sekolah_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
