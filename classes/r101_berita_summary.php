 ...
 * Page class
 */
class r101_berita_summary extends r101_berita
{
	...
	// Table name
	public $TableName = 'r101_berita';

	// Page object name
	public $PageObjName = "r101_berita_summary";
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["r101_berita"]) || get_class($GLOBALS["r101_berita"]) == PROJECT_NAMESPACE . "r101_berita") {
			$GLOBALS["r101_berita"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["r101_berita"];
		}
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'r101_berita');
	...
	public function loadGroupRowValues()
	{
		...
		if ($this->GroupCount < $cnt)
			$this->Tanggal->setGroupValue($this->GroupRecords[$this->GroupCount][0]);
		else
			$this->Tanggal->setGroupValue("");
	}
	...
	public function loadRowValues($record)
	{
		...
		$this->Tanggal->setDbValue(GroupValue($this->Tanggal, $record['Tanggal']));
		$this->Berita->setDbValue($record['Berita']);
	}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_SEARCH) { // Search row
			...
			$this->Tanggal->GroupViewValue = FormatDateTime($this->Tanggal->GroupViewValue, 7);
			$this->Tanggal->CellCssClass = ($this->RowGroupLevel == 1 ? "ew-rpt-grp-summary-1" : "ew-rpt-grp-field-1");
			...
			$this->Tanggal->GroupViewValue = $this->Tanggal->groupValue();
			$this->Tanggal->GroupViewValue = FormatDateTime($this->Tanggal->GroupViewValue, 7);
			$this->Tanggal->CellCssClass = "ew-rpt-grp-field-1";
			$this->Tanggal->ViewCustomAttributes = "";
			$this->Tanggal->GroupViewValue = DisplayGroupValue($this->Tanggal, $this->Tanggal->GroupViewValue);
			...
			$this->Berita->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "ew-table-row");
		...
		if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
			...
			// Berita
			$currentValue = $this->Berita->CurrentValue;
			$viewValue = &$this->Berita->ViewValue;
			$viewAttrs = &$this->Berita->ViewAttrs;
			$cellAttrs = &$this->Berita->CellAttrs;
			$hrefValue = &$this->Berita->HrefValue;
			$linkAttrs = &$this->Berita->LinkAttrs;
			$this->Cell_Rendered($this->Berita, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
		}
