 ...
 * Page class
 */
class t101_berita_add extends t101_berita
{
	...
	// Page object name
	public $PageObjName = "t101_berita_add";
	...
	public function run()
	{
		...
		if (!$this->setupApiRequest()) {
			...
			if (!$Security->canAdd()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t101_beritalist.php"));
				else
		...
		if (!$Security->canAdd()) {
			...
			$this->terminate("t101_beritalist.php");
			return;
		}
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("t101_beritalist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "t101_beritalist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "t101_beritaview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// Berita
		$this->Berita->setDbValueDef($rsnew, $this->Berita->CurrentValue, "", FALSE);
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t101_beritalist.php"), "", $this->TableVar, TRUE);
