...
class t002_tahunajaran_list extends t002_tahunajaran
{
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->TahunAjaran->AdvancedSearch->toJson(), ","); // Field TahunAjaran
		if ($this->BasicSearch->Keyword != "") {
	...
	protected function restoreFilterList()
	{
		...
		// Field TahunAjaran
		$this->TahunAjaran->AdvancedSearch->SearchValue = @$filter["x_TahunAjaran"];
		$this->TahunAjaran->AdvancedSearch->SearchOperator = @$filter["z_TahunAjaran"];
		$this->TahunAjaran->AdvancedSearch->SearchCondition = @$filter["v_TahunAjaran"];
		$this->TahunAjaran->AdvancedSearch->SearchValue2 = @$filter["y_TahunAjaran"];
		$this->TahunAjaran->AdvancedSearch->SearchOperator2 = @$filter["w_TahunAjaran"];
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->TahunAjaran, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->TahunAjaran); // TahunAjaran
