 ...
 * Page class
 */
class t101_berita_edit extends t101_berita
{
	...
	// Page object name
	public $PageObjName = "t101_berita_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Berita
			$this->Berita->setDbValueDef($rsnew, $this->Berita->CurrentValue, "", $this->Berita->ReadOnly);
