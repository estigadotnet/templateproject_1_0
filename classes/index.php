...
class index
{
	...
	public function run()
	{
		...
		if (!$Security->isLoggedIn())
			$Security->autoLogin();
		$Security->loadUserLevel(); // Load User Level
		if ($Security->allowList(CurrentProjectID() . 'd101_beranda'))
			$this->terminate("d101_berandadsb.php"); // Exit and go to default page
		if ($Security->allowList(CurrentProjectID() . 'r101_berita'))
			$this->terminate("r101_beritasmry.php");
		if ($Security->allowList(CurrentProjectID() . 'r202_users'))
			$this->terminate("r202_userssmry.php");
		...
		if ($Security->allowList(CurrentProjectID() . 't101_berita'))
