...
loadjs.ready("head", function() {
	...
	ft201_usersadd.lists["x_tahunajaran_id"] = <?php echo $t201_users_add->tahunajaran_id->Lookup->toClientList($t201_users_add) ?>;
	ft201_usersadd.lists["x_tahunajaran_id"].options = <?php echo JsonEncode($t201_users_add->tahunajaran_id->lookupOptions()) ?>;
	ft201_usersadd.lists["x_kelas_id"] = <?php echo $t201_users_add->kelas_id->Lookup->toClientList($t201_users_add) ?>;
	ft201_usersadd.lists["x_kelas_id"].options = <?php echo JsonEncode($t201_users_add->kelas_id->lookupOptions()) ?>;
	ft201_usersadd.lists["x_semester_id"] = <?php echo $t201_users_add->semester_id->Lookup->toClientList($t201_users_add) ?>;
	ft201_usersadd.lists["x_semester_id"].options = <?php echo JsonEncode($t201_users_add->semester_id->lookupOptions()) ?>;
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="t201_users" data-field="x_tahunajaran_id" data-page="1" data-value-separator="<?php echo $t201_users_add->tahunajaran_id->displayValueSeparatorAttribute() ?>" id="x_tahunajaran_id" name="x_tahunajaran_id"<?php echo $t201_users_add->tahunajaran_id->editAttributes() ?>>
			<?php echo $t201_users_add->tahunajaran_id->selectOptionListHtml("x_tahunajaran_id") ?>
		</select>
</div>
<?php echo $t201_users_add->tahunajaran_id->Lookup->getParamTag($t201_users_add, "p_x_tahunajaran_id") ?>
</span>
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="t201_users" data-field="x_kelas_id" data-page="1" data-value-separator="<?php echo $t201_users_add->kelas_id->displayValueSeparatorAttribute() ?>" id="x_kelas_id" name="x_kelas_id"<?php echo $t201_users_add->kelas_id->editAttributes() ?>>
			<?php echo $t201_users_add->kelas_id->selectOptionListHtml("x_kelas_id") ?>
		</select>
</div>
<?php echo $t201_users_add->kelas_id->Lookup->getParamTag($t201_users_add, "p_x_kelas_id") ?>
</span>
...
<div class="input-group">
	<select class="custom-select ew-custom-select" data-table="t201_users" data-field="x_semester_id" data-page="1" data-value-separator="<?php echo $t201_users_add->semester_id->displayValueSeparatorAttribute() ?>" id="x_semester_id" name="x_semester_id"<?php echo $t201_users_add->semester_id->editAttributes() ?>>
			<?php echo $t201_users_add->semester_id->selectOptionListHtml("x_semester_id") ?>
		</select>
</div>
<?php echo $t201_users_add->semester_id->Lookup->getParamTag($t201_users_add, "p_x_semester_id") ?>
</span>
...
<div class="custom-control custom-checkbox d-inline-block">
	<input type="checkbox" class="custom-control-input" data-table="t201_users" data-field="x_Activated" data-page="2" name="x_Activated[]" id="x_Activated[]_144744" value="1"<?php echo $selwrk ?><?php echo $t201_users_add->Activated->editAttributes() ?>>
	<label class="custom-control-label" for="x_Activated[]_144744"></label>
</div>
</span>
